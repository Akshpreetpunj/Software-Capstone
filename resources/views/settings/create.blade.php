...
<div class="container my-4">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Banner & Announcements') }}
                ...
                <div class="card-body">
                    ...
                    {{-- Banner & Announcement Create Form --}}
                    <form method="POST" action="{{ url('/settings') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="banner_image" type="file" class="form-control-file @error('banner_image') is-invalid @enderror" name="banner_image" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea name="announcement" id="announcement" class="form-control @error('announcement') is-invalid @enderror" rows="5" cols="50">{{ old('announcement') }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input id="publish_status" type="checkbox" class="form-check-input @error('publish_status') is-invalid @enderror" name="publish_status" {{ old('publish_status') ? 'checked' : '' }}>
