        ...
        <div class="col">
            <div class="card border-dark mb-3">
                <div class="card-header">
                    {{-- Back button --}}
                    <div class="text-left">
                        <a class="float-left btn btn-primary btn-sm" href="{{ route('my-ads') }}"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="justify-content-center text-center pt-4">
                                ...
                                {{-- Appointment Booking --}}
                                <form action="{{route('bookings.create', $advertisement->id)}}" id="bookings_form" method="GET" class="d-inline">
                                    <input name="advertisement_id" type="hidden" value="{{$advertisement->id}}" />
